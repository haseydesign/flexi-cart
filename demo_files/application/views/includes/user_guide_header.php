		...
		<div id="sub_nav_wrap" class="content">
			<ul id="sub_nav">
				...
				<li class="css_nav_dropmenu">
					Cart Configuration
					<ul>
						<li class="header">Internal Cart Config</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/cart_config_columns">Cart Columns</a>
						</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/cart_config_internal#validate_data">Data Validation Rules</a>
						</li>
						<li>
						...
						<li class="header">Database Config / Default Values</li>
						<li>
				...
				<li class="css_nav_dropmenu">
					Functions List
					<ul>
						<li class="header">Cart Session Data</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/cart_config_index">Cart Configuration</a>
						</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/cart_index">Cart Item / Summary Functions</a>
						</li>
						<li class="header">Localisation Data</li>
						<li>
						...
						<li class="header">Discounts / Rewards / Surcharges</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/discount_index">Discount Functions</a>
						</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/reward_index">Reward Point / Voucher Functions</a>
						</li>
						<li>
							<a href="<?php echo $base_url; ?>user_guide/surcharge_index">Surcharge Functions</a>
						</li>
						<li class="header">Orders / Database Cart Data</li>
						<li>
