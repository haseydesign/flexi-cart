...
<head>
	<meta charset="utf-8">
	<title>Admin Currency Functions | User Guide | flexi cart | A Shopping Cart Library for CodeIgniter</title>
	<meta name="description" content="The user guide for admin currency functions in flexi cart."/> 
	<meta name="keywords" content="admin currency functions, user guide, flexi cart, shopping cart, codeigniter"/>
...
<div id="body_wrap">
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="intro_text">
				<h1>User Guide | Admin Currency Functions</h1>
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			...
			<h2>Admin Currency Functions</h2>
			...
			<div class="anchor_nav">
				<h6>Currency CRUD Functions</h6>
				<p>
					<a href="#get_db_currency">get_db_currency()</a> | <a href="#insert_db_currency">insert_db_currency()</a> | <a href="#update_db_currency">update_db_currency()</a> | <a href="#delete_db_currency">delete_db_currency()</a>
				</p>
			</div>
			...
			<a name="get_db_currency"></a>
			<div class="w100 frame">
				<h3 class="heading">get_db_currency()</h3>
				
				<p>Gets records from the currency table.</p>
				<hr/>
				
				<h6>Library and Requirements</h6>
				<div class="frame_note">
					<p>Available via the admin library only.</p>
					<p>Requires the currency database table to be enabled.</p>
				</div>				
				
				<h6>Function Parameters</h6>
				<code>get_db_currency(sql_select, sql_where)</code>
				...
				<h6>How it Works</h6>
				<div class="frame_note">
					<p>The function runs an SQL SELECT statement on the 'Currency' table.</p>
...
$this->flexi_cart_admin->get_db_currency($sql_select, $sql_where)->result();
</pre>
			</div>

			<a name="insert_db_currency"></a>
			<div class="w100 frame">
				<h3 class="heading">insert_db_currency()</h3>
				
				<p>Inserts a new record to the currency table.</p>
				<hr/>
				...
				<h6>Function Parameters</h6>
				<code>insert_db_currency(sql_insert)</code>
				<a href="#help" class="help_link">Help</a>
				<table>
					<thead>
						<tr>
				...
				<h6>How it Works</h6>
				<div class="frame_note">
					<p>The function runs an SQL INSERT statement on the 'Currency' table, inserting data defined via the 'sql_insert' parameter.</p>
				</div>
...
$this->flexi_cart_admin->insert_db_currency($sql_insert);
			...
			<a name="update_db_currency"></a>
			<div class="w100 frame">
				<h3 class="heading">update_db_currency()</h3>
				
				<p>Updates records in the currency table.</p>
				<hr/>
				...
				<h6>Function Parameters</h6>
				<code>update_db_currency(sql_update, sql_where)</code>
				<a href="#help" class="help_link">Help</a>
				<table>
					<thead>
						<tr>
				...
				<h6>How it Works</h6>
				<div class="frame_note">
					<p>The function runs an SQL UPDATE statement on the 'Currency' table, updating data defined via the 'sql_update' parameter and filtered via the 'sql_where' parameter.</p>
				</div>
...
$this->flexi_cart_admin->update_db_currency($sql_update, $sql_where);
</pre>
			</div>

			<a name="delete_db_currency"></a>
			<div class="w100 frame">
				<h3 class="heading">delete_db_currency()</h3>
				
				<p>Deletes records from the currency table.</p>
				<hr/>
				...
				<h6>Function Parameters</h6>
				<code>delete_db_currency(sql_where)</code>
				<a href="#help" class="help_link">Help</a>
				<table>
					<thead>
						<tr>
				...
				<h6>How it Works</h6>
				<div class="frame_note">
					<p>The function runs an SQL DELETE statement on the 'Currency' table filtered via the 'sql_where' parameter.</p>
				</div>
...
$this->flexi_cart_admin->delete_db_currency($sql_where);
</pre>
			</div>
