...
<head>
	<meta charset="utf-8">
	<title>Query Builder | User Guide | flexi cart | A Shopping Cart Library for CodeIgniter</title>
	<meta name="description" content="A user guide list of building custom SQL queries in flexi cart functions."/> 
	<meta name="keywords" content="query builder functions, user guide, flexi cart, shopping cart, codeigniter"/>
...
<div id="body_wrap">
	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="intro_text">
				...
				<p>A guide to customising the SQL statements used by flexi cart functions to return database data.</p>
			</div>		
		</div>
	</div>
	...
	<div class="content_wrap main_content_bg">
		<div class="content clearfix">
			...
			<a href="<?php echo $base_url; ?>user_guide/custom_sql_admin">Misc. Admin Functions</a>
			...
			<div class="w100 frame">
				...
				<p>Many of the functions in the flexi cart admin library that perform CRUD operations to the carts database tables allow for custom SQL statements to be returned or defined when running the query.</p>
				...
				<p>The examples below explain how to set custom SQL statements using flexi cart functions that utilise CodeIgniters Active Record class.</p>
				<hr/>
				...
				<div class="frame_note">
					...
					<p>If a CodeIgniter Active Record function like <code>$this->db->where('x', 'y')</code> was called just before the flexi cart function, the defined WHERE statement would not necessarily be applied by CodeIgniter to the correct SQL query made by the flexi cart function. Instead it may be applied to one of the queries preparing data.</p>
					<p>To ensure that the custom SQL statement is applied to the correct query, flexi cart stores any SQL statements defined via its Query Builder functions, and applies them just prior to making the SQL query that returns the functions final output.</p>
				</div>
			...
			<div class="w100 frame">
				...
				<h6>Notes</h6>
				<div class="frame_note">
					<p>This function is typically compatible with SELECT query functions within the admin library.</p>
					<p>Check the functions user guide to confirm whether a function is compatible.</p>
				</div>
...
// FROM (`example_table`)</span>
			...
			<div class="w100 frame">
				...
				<h6>Notes</h6>
				<div class="frame_note">
					<p>This function is typically compatible with SELECT, UPDATE and DELETE query functions within the admin library.</p>
					<p>Check the functions user guide to confirm whether a function is compatible.</p>
				</div>
