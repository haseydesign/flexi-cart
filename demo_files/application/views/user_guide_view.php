	...
	<div class="content_wrap intro_bg">
		<div class="content clearfix">
			<div class="intro_text">
				...
				<p>The <strong>latest version is beta 1.0.2</strong>, released on 09/08/12. The <a href="<?php echo $base_url; ?>user_guide/change_log">change log</a> contains all amendments made to the library.</p>
			</div>		
		</div>
	</div>
